...
const fileData: ClientFolder[] = [
  {
    ...
    files: [
      ...
      { id: 'f3',  name: 'CV_Chen_Li.pdf',                 type: 'pdf',  size: '95 KB',  uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-06-10', category: 'CV' },
      { id: 'f4',  name: 'JD_Senior_Java_Engineer.docx',   type: 'docx', size: '38 KB',  uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-01', category: 'JD' },
      { id: 'f5',  name: 'JD_DevOps_Engineer.docx',        type: 'docx', size: '41 KB',  uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-01', category: 'JD' },
      { id: 'f6',  name: 'Contract_Chen_Li_Placed.pdf',    type: 'pdf',  size: '230 KB', uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-06-12', category: 'Contract' },
    ],
  },
  {
    clientId: 'c2',
    files: [
      { id: 'f7',  name: 'CV_Zhou_Xuan.pdf',               type: 'pdf',  size: '115 KB', uploadedBy: 'J. Park',     uploadedAt: '2026-06-25', category: 'CV' },
      { id: 'f8',  name: 'CV_Maya_Patel.pdf',              type: 'pdf',  size: '98 KB',  uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-19', category: 'CV' },
      { id: 'f9',  name: 'CV_Wang_Fang.pdf',               type: 'pdf',  size: '88 KB',  uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-06-28', category: 'CV' },
      { id: 'f10', name: 'JD_Risk_Manager_v2.docx',        type: 'docx', size: '45 KB',  uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-05', category: 'JD' },
      { id: 'f11', name: 'Offer_Letter_Wang_Fang.pdf',     type: 'pdf',  size: '185 KB', uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-06-28', category: 'Contract' },
      { id: 'f12', name: 'Pipeline_Report_Jun2026.xlsx',   type: 'xlsx', size: '62 KB',  uploadedBy: 'J. Park',     uploadedAt: '2026-06-30', category: 'Report' },
    ],
  },
  {
    clientId: 'c3',
    files: [
      { id: 'f13', name: 'CV_Yoshida_Sota.pdf',            type: 'pdf',  size: '145 KB', uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-06-20', category: 'CV' },
      { id: 'f14', name: 'CV_Li_Qiang.pdf',                type: 'pdf',  size: '112 KB', uploadedBy: 'J. Park',     uploadedAt: '2026-06-18', category: 'CV' },
      { id: 'f15', name: 'CV_David_Kim.pdf',               type: 'pdf',  size: '99 KB',  uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-25', category: 'CV' },
      { id: 'f16', name: 'JD_Systems_Architect.docx',      type: 'docx', size: '52 KB',  uploadedBy: 'H. Yamamoto', uploadedAt: '2026-05-15', category: 'JD' },
      { id: 'f17', name: 'JD_Cloud_Infra_Engineer.docx',   type: 'docx', size: '44 KB',  uploadedBy: 'H. Yamamoto', uploadedAt: '2026-05-15', category: 'JD' },
    ],
  },
  {
    clientId: 'c4',
    files: [
      { id: 'f18', name: 'CV_Chen_Yang.pdf',               type: 'pdf',  size: '105 KB', uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-22', category: 'CV' },
      { id: 'f19', name: 'JD_Business_Analyst.docx',       type: 'docx', size: '39 KB',  uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-06-01', category: 'JD' },
      { id: 'f20', name: 'Offer_Letter_Chen_Yang.pdf',     type: 'pdf',  size: '178 KB', uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-29', category: 'Contract' },
    ],
  },
  {
    clientId: 'c5',
    files: [
      { id: 'f21', name: 'CV_Isabella_Costa.pdf',          type: 'pdf',  size: '132 KB', uploadedBy: 'J. Park',     uploadedAt: '2026-06-20', category: 'CV' },
      { id: 'f22', name: 'CV_Chloe_Vanderbilt.pdf',        type: 'pdf',  size: '118 KB', uploadedBy: 'H. Yamamoto', uploadedAt: '2026-06-18', category: 'CV' },
      { id: 'f23', name: 'CV_Lu_Sheng.pdf',                type: 'pdf',  size: '96 KB',  uploadedBy: 'J. Park',     uploadedAt: '2026-06-22', category: 'CV' },
      { id: 'f24', name: 'JD_AI_Engineer.docx',            type: 'docx', size: '58 KB',  uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-05-20', category: 'JD' },
      { id: 'f25', name: 'SoftBank_Q2_Pipeline.xlsx',      type: 'xlsx', size: '74 KB',  uploadedBy: 'Y. Tanaka',   uploadedAt: '2026-07-01', category: 'Report' },
    ],
  },
]
